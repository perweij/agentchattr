...
Usage:
    ...
    uv run agentchattr agent my-local-model
...
def main(config: dict, args):
    from agentchattr.wrapper import _register_instance
    ...
    try:
        ...
        print("  Is the server running? Start it with: uv run agentchattr serve")
        sys.exit(1)
